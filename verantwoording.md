...
1. **Het gedachtestreepje wordt een komma.** De reden die in de code als `Kritisch proces`,
   gedachtestreepje, `onvolledig gedocumenteerd` staat, heet hier `Kritisch proces, onvolledig
   gedocumenteerd`; de commons schrijft geen gedachtestreepjes.
